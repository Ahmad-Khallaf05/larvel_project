    ...
    <div class="container">
        <form action="{{ route('search') }}" method="post" class="container mt-4">
            ...
            <div class="form-group">
                <label for="q" class="form-label">Search by category name</label>

                <div class="input-group" style="margin-top: 10px">

                    <input type="text" id="q" name="q" class="form-control" placeholder="Insert your category name" style="border: rgb(204, 204, 204) solid 1px">
